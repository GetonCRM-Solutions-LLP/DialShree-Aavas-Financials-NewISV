...
({
    ...
    renderPanel : function(cmp, params) {
        try {
            ...
            console.log('error at renderPanel method of dialShreeAdapterHelper --- ' , JSON.stringify(error));
            console.log('error message at renderPanel method of dialShreeAdapterHelper --- ' , JSON.stringify(error.message));
        }
    },
    ...
    setPanelLabel : function(cmp, panelLabel) {
        try {
            ...
            console.log('error at setPanelLabel method of dialShreeAdapterHelper --- ' , JSON.stringify(error));
            console.log('error message at setPanelLabel method of dialShreeAdapterHelper --- ' , JSON.stringify(error.message));
        }
    },
    ...
    getCallCenterSettings: function(cmp, callbackFunc) {
        try {
            ...
            console.log('error at getCallCenterSettings method of dialShreeAdapterHelper --- ' , JSON.stringify(error));
            console.log('error message at getCallCenterSettings method of dialShreeAdapterHelper --- ' , JSON.stringify(error.message));
        }
    },
    ...
    callbackStatus : function(cmp, event,helper) {       
        try {
            ...
            console.log('error at callbackStatus method of dialShreeAdapterHelper --- ' , JSON.stringify(error));
            console.log('error message at callbackStatus method of dialShreeAdapterHelper --- ' , JSON.stringify(error.message));
        }
    },
    ...
    statuCheckOpenCTI : function(cmp, event,helper) {    
        try {
            ...
            console.log('error at statuCheckOpenCTI method of dialShreeAdapterHelper --- ' , JSON.stringify(error));
            console.log('error message at statuCheckOpenCTI method of dialShreeAdapterHelper --- ' , JSON.stringify(error.message));
        }
    },
    ...
    apiData : function(cmp, event, helper) { 
        try {
            ...
            console.log('error at apiData method of dialShreeAdapterHelper --- ' , JSON.stringify(error));
            console.log('error message at apiData method of dialShreeAdapterHelper --- ' , JSON.stringify(error.message));
        }
    },
    ...
    wrapApiData : function(cmp, event, helper) { 
        try {
            ...
            console.log('error at wrapApiData method of dialShreeAdapterHelper --- ' , JSON.stringify(error));
            console.log('error message at wrapApiData method of dialShreeAdapterHelper --- ' , JSON.stringify(error.message));
        }
    },
    ...
    regenerateSessionSet : function(cmp, event, helper) {   
        try {
            ...
            console.log('error at regenerateSessionSet method of dialShreeAdapterHelper --- ' , JSON.stringify(error));
            console.log('error message at regenerateSessionSet method of dialShreeAdapterHelper --- ' , JSON.stringify(error.message));
        }      
    }
})