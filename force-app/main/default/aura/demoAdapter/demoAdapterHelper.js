...
({
    ...
    apiData : function(cmp, event, helper) { 
        ...
        action.setCallback(this,function(response){
            ...
            if (state === "SUCCESS") {
                cmp.set("v.baseUrl",response.getReturnValue().DialshreeCTI1__Base_Url__c);
                cmp.set("v.dialLogin",response.getReturnValue().DialshreeCTI1__Login__c);
                cmp.set("v.countryCodeMeta",response.getReturnValue().DialshreeCTI1__Country_Code__c);
            }
        });
        ...
        action2.setCallback(this,function(response){
            var state = response.getState();
            if (state === "SUCCESS") {                
                cmp.set("v.dialUser",response.getReturnValue().DialshreeCTI1__Dialshree_User__c);
            }
        });
